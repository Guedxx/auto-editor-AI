...
Examples:
  ...
  OptDef(names: "--ai", c: cEdit, kind: Flag, datum: "args.ai",
    help: "Use AI to plan cuts, speed changes, phrase boundaries, and face-aware zooms"),
  OptDef(names: "--ai-provider", c: cEdit, datum: "ai-provider", metavar: "PROVIDER",
    help: "Set the AI provider for --ai (default openai)"),
  OptDef(names: "--ai-model", c: cEdit, datum: "ai-model", metavar: "MODEL",
    help: "Set the LLM model for --ai"),
  OptDef(names: "--ai-whisper-model", c: cEdit, datum: "ai-whisper-model", metavar: "PATH",
    help: "Set the local whisper.cpp ggml model used by --ai"),
  OptDef(names: "--ai-whisper-command", c: cEdit, datum: "ai-whisper-command", metavar: "PATH",
    help: "Set the whisper.cpp CLI executable used when FFmpeg lacks the whisper filter"),
  OptDef(names: "--ai-whisper-python", c: cEdit, datum: "ai-whisper-python", metavar: "PATH",
    help: "Set the Python executable used for openai-whisper fallback"),
  OptDef(names: "--ai-language", c: cEdit, datum: "ai-language", metavar: "LANG",
    help: "Set the transcription language for --ai (default auto)"),
  OptDef(names: "--ai-chunk-secs", c: cEdit, datum: "ai-chunk-secs", metavar: "SECS",
    help: "Set the LLM planning chunk size for --ai (default 45)"),
  OptDef(names: "--ai-face-script", c: cEdit, datum: "ai-face-script", metavar: "PATH",
    help: "Set the OpenCV face tracking helper used by --ai"),
  OptDef(names: "--ai-python", c: cEdit, datum: "ai-python", metavar: "PATH",
    help: "Set the Python executable for OpenCV face tracking"),
  OptDef(names: "--ai-no-cache", c: cEdit, kind: Flag, datum: "args.aiNoCache",
    help: "Disable reading and writing the AI artifact cache"),
  OptDef(names: "--ai-dump-plan", c: cEdit, datum: "ai-dump-plan", metavar: "PATH",
    help: "Dump the AI-planned segments to PATH (JSON) and continue"),
  OptDef(names: "--ai-dry-run", c: cEdit, kind: Flag, datum: "args.aiDryRun",
    help: "Plan with AI but skip rendering. Useful with --ai-dump-plan"),
  OptDef(names: "--ai-debug-faces", c: cEdit, datum: "ai-debug-faces", metavar: "PATH",
    help: "Dump detected face tracks to PATH (JSON)"),
